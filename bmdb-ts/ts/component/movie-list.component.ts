...
while (command != "exit") {
    ...
    console.log("del - list all movie");
    ...
    switch (command) {
        ...
        case "get":
            ...
            console.log("---------------------------");
            let id: number = readline.questionInt("Movid ID? ");
            let movie: Movie = movieSvc.get(id);
            console.log(movie.about());
            break;
        case "add":
            console.log("Add a moive:");
            console.log("---------------------------");
            id = readline.questionInt("ID?  ");
            let title: string = readline.question("Title?")
            let year: number = readline.question("Year?")
